...
const _sfc_main = {
  ...
  data() {
    return {
      list: components_sub.universitySubList,
      dropdowns: {
        location: false,
        position: false
      },
  ...
  methods: {
    ...
    openDetail(item) {
      ...
      common_vendor.index.navigateTo({
        url: `/pages/universityDetail/universityDetail?item=${itemString}`
      });
    }
  }
};
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/cyd30/Documents/HBuilderProjects/wechat_program-mianjing-front/pages/universitySubpage/universitySubpage.vue"]]);
